...
//webelement screenshot
    ...
    // Faker Methods for generating fake data
    ...
    // Generate Fake City
    public static String cityCreator() {
        return faker.address().cityName();
    }

    // Generate Fake zipCode
    public static String zipCodeCreator() {
        return faker.address().zipCode();
    }

    // Generate Fake Address
    public static String fullAddressCreator() {
    ...
    public static String phoneNumberCreator() {
        ...
        return fakeValuesService.regexify("544" + "-\\d{3}-\\d{4}");
    }
